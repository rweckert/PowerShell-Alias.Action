# cd.development.ps1 v004 02/08/2023
# Alias: cd.development    Change to users development directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.development.ps1
...
Logo
Write-Host ""
Write-Host " cd.development v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.development.ps1"
...
Write-Host "cd.development is a utility that allows a user to change to or explore the development directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.development         Default option changes to directory."
Write-Host "cd.development e       Open location with development Explorer."
Write-Host "cd.development l       Open location with notepad showing list of all items."
Write-Host "cd.development v       Open location with grid-view listing of all items."
Write-Host "cd.development i       Open location and display item totals."
Write-Host "cd.development a       Version and license information."
Write-Host "cd.development h       Help documentation.`n"
