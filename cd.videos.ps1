# cd.videos.ps1 v004 02/08/2023
# Alias: cd.videos    Change to users videos directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.videos.ps1
...
Logo
Write-Host ""
Write-Host " cd.videos v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.videos.ps1"
...
Write-Host "cd.videos is a utility that allows a user to change to or explore the Users Videos directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.videos         Default option changes to directory."
Write-Host "cd.videos e       Open location with Windows Explorer."
Write-Host "cd.videos l       Open location with notepad showing list of all items."
Write-Host "cd.videos v       Open location with grid-view listing of all items."
Write-Host "cd.videos i       Open location and display item totals."
Write-Host "cd.videos a       Version and license information."
Write-Host "cd.videos h       Help documentation.`n"
