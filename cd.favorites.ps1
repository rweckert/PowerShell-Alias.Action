# cd.favorites.ps1 v004 02/08/2023
# Alias: cd.favorites    Change to users favorites directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.favorites.ps1
...
Logo
Write-Host ""
Write-Host " cd.favorites v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.favorites.ps1"
...
Write-Host "cd.favorites is a utility that allows a user to change to or explore the Users favorites directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.favorites         Default option changes to directory."
Write-Host "cd.favorites e       Open location with Windows Explorer."
Write-Host "cd.favorites l       Open location with notepad showing list of all items."
Write-Host "cd.favorites v       Open location with grid-view listing of all items."
Write-Host "cd.favorites i       Open location and display item totals."
Write-Host "cd.favorites a       Version and license information."
Write-Host "cd.favorites h       Help documentation.`n"
