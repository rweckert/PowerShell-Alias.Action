# cd.projects.ps1 v004 02/08/2023
# Alias: cd.projects    Change to users projects directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.projects.ps1
...
Logo
Write-Host ""
Write-Host " cd.projects v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.projects.ps1"
...
Write-Host "cd.projects is a utility that allows a user to change to or explore the projects directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.projects         Default option changes to directory."
Write-Host "cd.projects e       Open location with projects Explorer."
Write-Host "cd.projects l       Open location with notepad showing list of all items."
Write-Host "cd.projects v       Open location with grid-view listing of all items."
Write-Host "cd.projects i       Open location and display item totals."
Write-Host "cd.projects a       Version and license information."
Write-Host "cd.projects h       Help documentation.`n"
