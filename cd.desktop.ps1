...
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.desktop.ps1"
...
Write-Host "cd.desktop         Default option changes to directory."
Write-Host "cd.desktop e       Open location with Windows Explorer."
Write-Host "cd.desktop l       Open location with notepad showing list of all items."
Write-Host "cd.desktop v       Open location with grid-view listing of all items."
Write-Host "cd.desktop i       Open location and display item totals."
