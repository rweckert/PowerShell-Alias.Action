# cd.sys64.ps1 v004 02/08/2023
# Alias: cd.sys64    Change to users sys64 directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.sys64.ps1
...
Logo
Write-Host ""
Write-Host " cd.sys64 v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.sys64.ps1"
...
Write-Host "cd.sys64 is a utility that allows a user to change to or explore the Windows\SysWOW64 directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.sys64         Default option changes to directory."
Write-Host "cd.sys64 e       Open location with sys64 Explorer."
Write-Host "cd.sys64 l       Open location with notepad showing list of all items."
Write-Host "cd.sys64 v       Open location with grid-view listing of all items."
Write-Host "cd.sys64 i       Open location and display item totals."
Write-Host "cd.sys64 a       Version and license information."
Write-Host "cd.sys64 h       Help documentation.`n"
