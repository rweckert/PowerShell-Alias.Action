# cd.applications.ps1 v004 02/08/2023
# Alias: cd.applications    Change to users applications directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.applications.ps1
...
Logo
Write-Host ""
Write-Host " cd.applications v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.applications.ps1"
...
Write-Host "cd.applications is a utility that allows a user to change to or explore the applications directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.applications         Default option changes to directory."
Write-Host "cd.applications e       Open location with applications Explorer."
Write-Host "cd.applications l       Open location with notepad showing list of all items."
Write-Host "cd.applications v       Open location with grid-view listing of all items."
Write-Host "cd.applications i       Open location and display item totals."
Write-Host "cd.applications a       Version and license information."
Write-Host "cd.applications h       Help documentation.`n"
