# cd.documents.ps1 v004 02/08/2023
# Alias: cd.documents    Change to users documents directory.
...
Logo
Write-Host ""
Write-Host " cd.documents v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.documents.ps1"
...
Write-Host "cd.documents is a utility that allows a user to change to or explore the Users Desktop directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.documents         Default option changes to directory."
Write-Host "cd.documents e       Open location with Windows Explorer."
Write-Host "cd.documents l       Open location with notepad showing list of all items."
Write-Host "cd.documents v       Open location with grid-view listing of all items."
Write-Host "cd.documents i       Open location and display item totals."
Write-Host "cd.documents a       Version and license information."
Write-Host "cd.documents h       Help documentation.`n"
