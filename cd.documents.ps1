...
# Source: https://github.com/rweckert/alias.action/blob/main/cd.documents.ps1
...
Write-Host " Source: https://github.com/rweckert/PowerShell-Script-Utilities/blob/main/cd.documents.ps1"
...
Write-Host "cd.documents is a utility that allows a user to change to or explore the documents directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.documents         Default option changes current directory to documents."
Write-Host "cd.documents e       Open Desktop location with Windows Explorer."
Write-Host "cd.documents i       Display number of items and change directory to documents."
