# cd.apps.ps1 v004 02/08/2023
# Alias: cd.apps    Change to WindowsApps directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.apps.ps1
...
Logo
Write-Host ""
Write-Host " cd.apps v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.apps.ps1"
...
Write-Host "cd.apps is a utility that allows a user to change to or explore the Program Files directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.apps         Default option changes to directory."
Write-Host "cd.apps e       Open location with apps Explorer."
Write-Host "cd.apps l       Open location with notepad showing list of all items."
Write-Host "cd.apps v       Open location with grid-view listing of all items."
Write-Host "cd.apps i       Open location and display item totals."
Write-Host "cd.apps a       Version and license information."
Write-Host "cd.apps h       Help documentation.`n"
...
# Common Variables --------------------
$cP="\Program Files\WindowsApps"
$tL=$env:SystemDrive+"$cP"
$tP=$env:TEMP #tP appsorary path
$tF="aaction.txt" #tF appsorary file
