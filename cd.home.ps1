# cd.home.ps1 v004 02/08/2023
# Alias: cd.home    Change to users home directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.homne.ps1
...
Logo
Write-Host ""
Write-Host " cd.home v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.home.ps1"
...
Write-Host "cd.home is a utility that allows a user to change to or explore the Users Home directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.home         Default option changes to directory."
Write-Host "cd.home e       Open location with Windows Explorer."
Write-Host "cd.home l       Open location with notepad showing list of all items."
Write-Host "cd.home v       Open location with grid-view listing of all items."
Write-Host "cd.home i       Open location and display item totals."
Write-Host "cd.home a       Version and license information."
Write-Host "cd.home h       Help documentation.`n"
