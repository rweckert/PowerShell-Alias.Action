...
Write-Host " Source: https://github.com/rweckert/PowerShell-Script-Utilities/blob/main/cd.music.ps1"
...
Write-Host "cd.music is a utility that allows a user to change to or explore the Music directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.music         Default option changes current directory to Music."
Write-Host "cd.music e       Open Desktop location with Windows Explorer."
Write-Host "cd.music i       Display number of items and change directory to Music."
