# cd.music.ps1 v004 02/08/2023
# Alias: cd.music    Change to users music directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.music.ps1
...
Logo
Write-Host ""
Write-Host " cd.music v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.music.ps1"
...
Write-Host "cd.music is a utility that allows a user to change to or explore the Users Music directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.music         Default option changes to directory."
Write-Host "cd.music e       Open location with Windows Explorer."
Write-Host "cd.music l       Open location with notepad showing list of all items."
Write-Host "cd.music v       Open location with grid-view listing of all items."
Write-Host "cd.music i       Open location and display item totals."
Write-Host "cd.music a       Version and license information."
Write-Host "cd.music h       Help documentation.`n"
