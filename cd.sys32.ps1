# cd.sys32.ps1 v004 02/08/2023
# Alias: cd.sys32    Change to users sys32 directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.sys32.ps1
...
Logo
Write-Host ""
Write-Host " cd.sys32 v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.sys32.ps1"
...
Write-Host "cd.sys32 is a utility that allows a user to change to or explore the Windows\System32 directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.sys32         Default option changes to directory."
Write-Host "cd.sys32 e       Open location with sys32 Explorer."
Write-Host "cd.sys32 l       Open location with notepad showing list of all items."
Write-Host "cd.sys32 v       Open location with grid-view listing of all items."
Write-Host "cd.sys32 i       Open location and display item totals."
Write-Host "cd.sys32 a       Version and license information."
Write-Host "cd.sys32 h       Help documentation.`n"
