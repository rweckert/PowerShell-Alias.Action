# cd.onedrive.ps1 v004 02/08/2023
# Alias: cd.onedrive    Change to users onedrive directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.onedrive.ps1
...
Logo
Write-Host ""
Write-Host " cd.temp v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.onedrive.ps1"
...
Logo
Write-Host ""
Write-Host " cd.onedrive v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " Navigation Utility`n" -BackgroundColor Black -ForegroundColor White
Write-Host "cd.onedrive is a utility that allows a user to change to or explore the temp directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.onedrive         Default option changes to directory."
Write-Host "cd.onedrive e       Open location with temp Explorer."
Write-Host "cd.onedrive l       Open location with notepad showing list of all items."
Write-Host "cd.onedrive v       Open location with grid-view listing of all items."
Write-Host "cd.onedrive i       Open location and display item totals."
Write-Host "cd.onedrive a       Version and license information."
Write-Host "cd.onedrive h       Help documentation.`n"
