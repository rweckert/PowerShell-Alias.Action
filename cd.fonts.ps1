# cd.fonts.ps1 v004 02/08/2023
# Alias: cd.fonts    Change to users fonts directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.fonts.ps1
...
Logo
Write-Host ""
Write-Host " cd.fonts v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.fonts.ps1"
...
Write-Host "cd.fonts is a utility that allows a user to change to or explore the Fonts directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.fonts         Default option changes to directory."
Write-Host "cd.fonts e       Open location with fonts Explorer."
Write-Host "cd.fonts l       Open location with notepad showing list of all items."
Write-Host "cd.fonts v       Open location with grid-view listing of all items."
Write-Host "cd.fonts i       Open location and display item totals."
Write-Host "cd.fonts a       Version and license information."
Write-Host "cd.fonts h       Help documentation.`n"
