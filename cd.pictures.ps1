# cd.pictures.ps1 v004 02/08/2023
# Alias: cd.pictures    Change to users pictures directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.pictures.ps1
...
Logo
Write-Host ""
Write-Host " cd.pictures v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.pictures.ps1"
...
Write-Host "cd.pictures is a utility that allows a user to change to or explore the Users Pictures directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.pictures         Default option changes to directory."
Write-Host "cd.pictures e       Open location with Windows Explorer."
Write-Host "cd.pictures l       Open location with notepad showing list of all items."
Write-Host "cd.pictures v       Open location with grid-view listing of all items."
Write-Host "cd.pictures i       Open location and display item totals."
Write-Host "cd.pictures a       Version and license information."
Write-Host "cd.pictures h       Help documentation.`n"
