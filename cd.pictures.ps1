...
Write-Host "cd.pictures is a utility that allows a user to change to or explore the Pictures directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.pictures         Default option changes current directory to Pictures."
Write-Host "cd.pictures e       Open Desktop location with Windows Explorer."
Write-Host "cd.pictures i       Display number of items and change directory to Pictures."
