# cd.temp.ps1 v004 02/08/2023
# Alias: cd.temp    Change to users temp directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.temp.ps1
...
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.temp.ps1"
...
Write-Host "cd.temp is a utility that allows a user to change to or explore the temp directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.temp         Default option changes to directory."
Write-Host "cd.temp e       Open location with temp Explorer."
Write-Host "cd.temp l       Open location with notepad showing list of all items."
Write-Host "cd.temp v       Open location with grid-view listing of all items."
Write-Host "cd.temp i       Open location and display item totals."
Write-Host "cd.temp a       Version and license information."
Write-Host "cd.temp h       Help documentation.`n"
