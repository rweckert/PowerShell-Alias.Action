# cd.downloads.ps1 v004 02/08/2023
# Alias: cd.downloads    Change to users downloads directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.downloads.ps1
...
Logo
Write-Host ""
Write-Host " cd.downloads v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.downloads.ps1"
...
Write-Host "cd.downloads is a utility that allows a user to change to or explore the Users Downloads directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.downloads         Default option changes to directory."
Write-Host "cd.downloads e       Open location with Windows Explorer."
Write-Host "cd.downloads l       Open location with notepad showing list of all items."
Write-Host "cd.downloads v       Open location with grid-view listing of all items."
Write-Host "cd.downloads i       Open location and display item totals."
Write-Host "cd.downloads a       Version and license information."
Write-Host "cd.downloads h       Help documentation.`n"
