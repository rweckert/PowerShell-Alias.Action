# cd.cursors.ps1 v004 02/08/2023
# Alias: cd.cursors    Change to users cursors directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.cursors.ps1
...
Logo
Write-Host ""
Write-Host " cd.cursors v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.cursors.ps1"
...
Write-Host "cd.cursors is a utility that allows a user to change to or explore the Windows\Cursors directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.cursors         Default option changes to directory."
Write-Host "cd.cursors e       Open location with cursors Explorer."
Write-Host "cd.cursors l       Open location with notepad showing list of all items."
Write-Host "cd.cursors v       Open location with grid-view listing of all items."
Write-Host "cd.cursors i       Open location and display item totals."
Write-Host "cd.cursors a       Version and license information."
Write-Host "cd.cursors h       Help documentation.`n"
