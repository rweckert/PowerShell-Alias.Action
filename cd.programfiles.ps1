# cd.programfiles.ps1 v004 02/08/2023
# Alias: cd.programfiles    Change to users programfiles directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.programfiles.ps1
...
Logo
Write-Host ""
Write-Host " cd.programfiles v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.programfiles.ps1"
...
Write-Host "cd.programfiles is a utility that allows a user to change to or explore the Program Files directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.programfiles         Default option changes to directory."
Write-Host "cd.programfiles e       Open location with programfiles Explorer."
Write-Host "cd.programfiles l       Open location with notepad showing list of all items."
Write-Host "cd.programfiles v       Open location with grid-view listing of all items."
Write-Host "cd.programfiles i       Open location and display item totals."
Write-Host "cd.programfiles a       Version and license information."
Write-Host "cd.programfiles h       Help documentation.`n"
...
$tP=$env:TEMP #tP programfilesorary path
$tF="aaction.txt" #tF programfilesorary file
