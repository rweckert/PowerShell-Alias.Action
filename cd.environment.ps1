# cd.environment.ps1 v004 02/08/2023
# Alias: cd.environment    Change to users environment directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.environment.ps1
...
Logo
Write-Host ""
Write-Host " cd.environment v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.environment.ps1"
...
Write-Host "cd.environment is a utility that allows a user to change to or explore the environment directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.environment         Default option changes to directory."
Write-Host "cd.environment e       Open location with environment Explorer."
Write-Host "cd.environment l       Open location with notepad showing list of all items."
Write-Host "cd.environment v       Open location with grid-view listing of all items."
Write-Host "cd.environment i       Open location and display item totals."
Write-Host "cd.environment a       Version and license information."
Write-Host "cd.environment h       Help documentation.`n"
