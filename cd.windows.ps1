# cd.windows.ps1 v004 02/08/2023
# Alias: cd.windows    Change to users windows directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.windows.ps1
...
Logo
Write-Host ""
Write-Host " cd.windows v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.windows.ps1"
...
Write-Host "cd.windows is a utility that allows a user to change to or explore the Windows directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.windows         Default option changes to directory."
Write-Host "cd.windows e       Open location with Windows Explorer."
Write-Host "cd.windows l       Open location with notepad showing list of all items."
Write-Host "cd.windows v       Open location with grid-view listing of all items."
Write-Host "cd.windows i       Open location and display item totals."
Write-Host "cd.windows a       Version and license information."
Write-Host "cd.windows h       Help documentation.`n"
