# cd.backups.ps1 v004 02/08/2023
# Alias: cd.backups    Change to users backups directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.backups.ps1
...
Logo
Write-Host ""
Write-Host " cd.backups v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.backups.ps1"
...
Write-Host "cd.backups is a utility that allows a user to change to or explore the backups directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.backups         Default option changes to directory."
Write-Host "cd.backups e       Open location with backups Explorer."
Write-Host "cd.backups l       Open location with notepad showing list of all items."
Write-Host "cd.backups v       Open location with grid-view listing of all items."
Write-Host "cd.backups i       Open location and display item totals."
Write-Host "cd.backups a       Version and license information."
Write-Host "cd.backups h       Help documentation.`n"
