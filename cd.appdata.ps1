# cd.appdata.ps1 v004 02/08/2023
# Alias: cd.appdata    Change to users appdata directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.appdata.ps1
...
Logo
Write-Host ""
Write-Host " cd.appdata v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.appdata.ps1"
...
Write-Host "cd.appdata is a utility that allows a user to change to or explore the appdata directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.appdata         Default option changes to directory."
Write-Host "cd.appdata e       Open location with appdata Explorer."
Write-Host "cd.appdata l       Open location with notepad showing list of all items."
Write-Host "cd.appdata v       Open location with grid-view listing of all items."
Write-Host "cd.appdata i       Open location and display item totals."
Write-Host "cd.appdata a       Version and license information."
Write-Host "cd.appdata h       Help documentation.`n"
...
$cP=""
$tL=$env:AppData+"$cP"
$tP=$env:TEMP #tP appdataorary path
$tF="aaction.txt" #tF appdataorary file
