# cd.sandbox.ps1 v004 02/08/2023
# Alias: cd.sandbox    Change to users sandbox directory.
# robert w eckert - rweckert@gmail.com
# Source: https://github.com/rweckert/alias.action/blob/main/cd.sandbox.ps1
...
Logo
Write-Host ""
Write-Host " cd.sandbox v:004 " -BackgroundColor White -ForegroundColor Black -NoNewLine
Write-Host " robert w eckert - rweckert@gmail.com`n"
Write-Host " Source: https://github.com/rweckert/alias.action/blob/main/cd.sandbox.ps1"
...
Write-Host "cd.sandbox is a utility that allows a user to change to or explore the sandbox directory."
Write-Host "This script can be utilized with command switches as described below:`n"
Write-Host "cd.sandbox         Default option changes to directory."
Write-Host "cd.sandbox e       Open location with sandbox Explorer."
Write-Host "cd.sandbox l       Open location with notepad showing list of all items."
Write-Host "cd.sandbox v       Open location with grid-view listing of all items."
Write-Host "cd.sandbox i       Open location and display item totals."
Write-Host "cd.sandbox a       Version and license information."
Write-Host "cd.sandbox h       Help documentation.`n"
